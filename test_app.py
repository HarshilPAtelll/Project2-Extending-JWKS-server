...
class JWKSAppTest(unittest.TestCase):
    def setUp(self):
        ...
        # Save an expired and a valid key to the database
    ...
    def test_auth_unexpired_key(self):
        # Test the /auth endpoint without the expired parameter
    ...
    def test_auth_expired_key(self):
        # Test the /auth endpoint with the expired parameter to get an expired key
        with app.app.test_client() as client:
    ...
    def test_jwks_route(self):
        ...
        with app.app.test_client() as client:
            ...
            # Verify at least one valid key is returned
